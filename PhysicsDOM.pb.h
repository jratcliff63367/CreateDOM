...
enum NodeType {
  ...
  NT_REVOLUTE_JOINT = 13,
  NT_PRISMATIC_JOINT = 14,
  NT_DISTANCE_JOINT = 15,
  NT_D6_JOINT = 16,
  NT_INSTANCE_COLLECTION = 17,
  NT_COLLECTION = 18,
  NT_SCENE = 19,
...
class Node : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CreateDOM.Node) */ {
 public:
  ...
  static const int kPhysicsMaterialFieldNumber = 5;
  ...
  static const int kConvexHullFieldNumber = 6;
  ...
  static const int kTriangleMeshFieldNumber = 7;
  ...
  static const int kHeightFieldFieldNumber = 8;
...
class FixedJoint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CreateDOM.FixedJoint) */ {
 public:
  ...
  void clear_projectionlineartolerance();
  static const int kProjectionLinearToleranceFieldNumber = 1;
  float projectionlineartolerance() const;
  void set_projectionlineartolerance(float value);

  // float projectionAngularTolerance = 2;
  void clear_projectionangulartolerance();
  static const int kProjectionAngularToleranceFieldNumber = 2;
  float projectionangulartolerance() const;
  void set_projectionangulartolerance(float value);
...
// float projectionLinearTolerance = 1;
inline void FixedJoint::clear_projectionlineartolerance() {
  projectionlineartolerance_ = 0;
}
inline float FixedJoint::projectionlineartolerance() const {
  // @@protoc_insertion_point(field_get:CreateDOM.FixedJoint.projectionLinearTolerance)
  return projectionlineartolerance_;
}
inline void FixedJoint::set_projectionlineartolerance(float value) {
...
// float projectionAngularTolerance = 2;
inline void FixedJoint::clear_projectionangulartolerance() {
  projectionangulartolerance_ = 0;
}
inline float FixedJoint::projectionangulartolerance() const {
  // @@protoc_insertion_point(field_get:CreateDOM.FixedJoint.projectionAngularTolerance)
  return projectionangulartolerance_;
}
inline void FixedJoint::set_projectionangulartolerance(float value) {
